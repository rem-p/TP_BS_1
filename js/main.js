...
---------------------------*/
$(function () {
	$("#optionInfos").click(function () {
		$("#msg").attr("placeholder","Message...");
		$("#labelForNbPlaces").prop("hidden",true);
		$("#selectionNbPlaces").prop("hidden",true);
	});
	$("#optionReserv").click(function () {
		$("#msg").attr("placeholder","Commentaire (facultatif)");
		$("#labelForNbPlaces").prop("hidden",false);
		$("#selectionNbPlaces").prop("hidden",false);
	});
	$("#optionAchat").click(function () {
		$("#msg").attr("placeholder","Message (précisez le(s) numéro(s) de la / des photo(s) désirée(s))");
		$("#labelForNbPlaces").prop("hidden",true);
		$("#selectionNbPlaces").prop("hidden",true);
	});
});
